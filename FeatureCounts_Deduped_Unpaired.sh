...
#PBS -o /scratch/wsspaces/nsharma-Alessio_ACseries-0/LogFCountsKnownGeneDedupedUnpaired
#PBS -e /scratch/wsspaces/nsharma-Alessio_ACseries-0/LogFCountsKnownGeneDedupedUnpaired
#PBS -j oe
#PBS -V
##PBS -A tartheonc
...
###################################### Feature counts ############################
mkdir -p ../FeatureCounts_Deduped_Unpaired
...
do
    ...
    featureCounts -T 16 \
                  ...
                  -o ../FeatureCounts_Deduped_Unpaired/${fbname}".fCounts.txt" \
                  $filename 
done