...
#PBS -o /scratch/wsspaces/nsharma-Alessio_ACseries-0/LogFCountsKnownGeneOriginalPaired
#PBS -e /scratch/wsspaces/nsharma-Alessio_ACseries-0/LogFCountsKnownGeneOriginalPaired
#PBS -j oe
#PBS -V
##PBS -A tartheonc
